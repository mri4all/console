...
RF_PI2_FRACTION = (
    configuration_data.rf_parameters.rf_pi2_fraction
)  # Fraction of power to expect a pi/2 pulse

GX_MAX = (
    configuration_data.gradients_parameters.gx_maximum
)  # System maximum X gradient strength, in Hz/m
GY_MAX = (
    configuration_data.gradients_parameters.gy_maximum
)  # System maximum Y gradient strength, in Hz/m
GZ_MAX = (
    configuration_data.gradients_parameters.gz_maximum
