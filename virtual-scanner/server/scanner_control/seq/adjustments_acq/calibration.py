...
import sys
import virtualscanner.server.scanner_control.seq.adjustments_acq.config as cfg  # pylint: disable=import-error
...
import virtualscanner.server.scanner_control.seq.adjustments_acq.scripts as scr  # pylint: disable=import-error
...
def shim_cal(larmor_freq=cfg.LARMOR_FREQ, channel='x', range=0.01, shim_points=3, points=2, iterations=1, zoom_factor=2,
             ...
             tr_spacing=2, force_tr=False, first_max=False, smooth=True, plot=True, gui_test=False):
    """
    Calibrate shims for imaging volume
