...
from external.seq.adjustments_acq.calibration import larmor_cal, larmor_step_search, load_plot_in_ui
...
class AdjFrequency(PulseqSequence, registry_key=Path(__file__).stem):
    ...
    def run_sequence(self, scan_task) -> bool:
        ...
        plot_result_signal1 = load_plot_in_ui(working_folder= working_folder, file_name = "plot_result_signal1", fig=fig_signal1)
        scan_task.results.append(plot_result_signal1)
        plot_result_noise1 = load_plot_in_ui(working_folder= working_folder, file_name = "plot_result_noise1", fig=fig_noise1)
        scan_task.results.append(plot_result_noise1)

        opt_max_freq, opt_max_snr_freq, data_dict, fig_signal2, fig_noise2 = larmor_step_search(
            seq_file=self.seq_file_path,
        ...
        plot_result_signal2 = load_plot_in_ui(working_folder= working_folder, file_name = "plot_result_signal2", fig=fig_signal2)
        scan_task.results.append(plot_result_signal2)
        plot_result_noise2 = load_plot_in_ui(working_folder= working_folder, file_name = "plot_result_noise2", fig=fig_noise2)
        ...
        plot_result1 = load_plot_in_ui(working_folder= working_folder, file_name = "plot_result1", fig=fig1)
        ...
        plot_result2 = load_plot_in_ui(working_folder= working_folder, file_name = "plot_result2", fig=fig2)
